...
class PricelistPartnerinfo(models.Model):
    ...
    min_quantity = fields.Float('Quantity', help="The minimal quantity to trigger this rule, expressed in the supplier Unit of Measure if any or in the default Unit of Measure of the product otherrwise.")
