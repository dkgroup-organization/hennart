...
SHIPPINGMULTIPARCELV6 = [
    ...
    # refValueV2 [x]
    {
        'struct': 'refValueV2',
        'required': True,
        'loop': "data['picking'].sscc_line_ids.mapped('result_package_id')",
        'content': [
    ...
    # skybillWithDimensionsValueV5 [x]
    {
        ...
        'content': [
            {
                'dst': 'bulkNumber',
                'src': "len(data['picking'].sscc_line_ids.mapped("
                    "'result_package_id'))",
                'default': '1',
                },
            {
    ...
    # simple data
    {
        'content': [
            ...
            {
                'dst': 'multiparcel',
                'src': ("'Y' if len(data['picking'].sscc_line_ids.mapped("
...
class ChronopostRequest():
    ...
    def shipping_request(self,**data):
        ...
        if not all([
                ...
                for po in data['picking'].sscc_line_ids]):
